  ...
  return (
    <div className="w-4/5 flex justify-center">
      <div className="p-5 prose prose-invert">
        ...
        <p>Welcome to Youtube Playlist Player!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Youtube Playlist Player&#39;s Website, located at{" "}
          <a href="https://ypp.eriko.dev/">https://ypp.eriko.dev/</a>.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use YouTube Playlists but in a Spotify
          styled environment if you do not agree to take all of the terms and
        ...
        <p>
          ...
          and subject to, prevailing law of de. Any use of the above terminology
          ...
          same. Our Terms and Conditions were created with the help of the Terms
          &amp; Conditions Generator. Cookies
        </p>
        <p>
          We employ the use of cookies. By accessing Youtube Playlist Player,
          you agreed to use cookies in agreement with the Youtube Playlist
          Player&#39;s Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Youtube Playlist Player and/or its licensors
          own the intellectual property rights for all material on Youtube
          Playlist Player. All intellectual property rights are reserved. You
          may access this from Youtube Playlist Player for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <p>
          Republish material from Youtube Playlist Player Sell, rent or
          sub-license material from Youtube Playlist Player. Reproduce,
          duplicate or copy material from Youtube Playlist Player Redistribute
          content from Youtube Playlist Player
        </p>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.
          Youtube Playlist Player does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Youtube Playlist Player,its agents
          ...
          applicable laws, Youtube Playlist Player shall not be liable for the
        ...
        <p>
          Youtube Playlist Player reserves the right to monitor all Comments and
        ...
        <p>
          You hereby grant Youtube Playlist Player a non-exclusive license to
        ...
        <p>
          ...
          the hyperlink compensates the absence of Youtube Playlist Player; and
        ...
        <p>
          ...
          sending an e-mail to Youtube Playlist Player. Please include your
        ...
        <p>
          No use of Youtube Playlist Player&#39;s logo or other artwork will be
